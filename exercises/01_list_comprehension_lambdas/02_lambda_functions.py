...
annual_premiums_lambda = list()  # answer here, hint: use map()
...
high_premiums_lambda = list()  # answer here, hint: use filter()
...
numbers = [1, 2, 3, 4, 5]
squared_numbers = list()  # answer here, hint: use map()
...
premiums_sorted_lambda = list()  # answer here, hint: use sorted()
...
policies_sorted = list()  # answer here, hint: use sorted()
