...
class TestGetProductQuantity(unittest.TestCase):
    ...
    def test_get_product_quantity_available(self) -> None:
        product_id = 1
    ...
    def test_get_product_quantity_out_of_stock(self) -> None:
        product_id = 2
        expected_quantity = 0
    ...
    def test_get_product_quantity_nonexistent_product(self) -> None:
        product_id = 99
