...
def test_get_product_quantity_available(mock_db_connection: MagicMock) -> None:
    product_id = 1
...
def test_get_product_quantity_out_of_stock(mock_db_connection: MagicMock) -> None:
    product_id = 2
    expected_quantity = 0
...
def test_get_product_quantity_nonexistent_product(mock_db_connection: MagicMock) -> None:
    product_id = 99
